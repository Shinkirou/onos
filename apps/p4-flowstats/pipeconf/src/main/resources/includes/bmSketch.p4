control c_bmSketch(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    action bm_new_pair() {
        ...
        meta.bm_meta.bm_1_sketch = meta.bm_meta.bm_1_sketch + 1;
        meta.bm_meta.bm_2_sketch = meta.bm_meta.bm_2_sketch + 1;

        bm_0_register.write((bit<32>)meta.bm_meta.bm_0_hash, 1);
        bm_1_register.write((bit<32>)meta.bm_meta.bm_1_hash, meta.bm_meta.bm_1_sketch);
        bm_2_register.write((bit<32>)meta.bm_meta.bm_2_hash, meta.bm_meta.bm_2_sketch);
    }
