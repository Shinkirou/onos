...
package org.onosproject.p4kitsune.pipeconf;
...
/**
 * Implementation of a pipeline interpreter for the kitsune.p4 program.
 */
public final class PipelineInterpreterImpl extends AbstractHandlerBehaviour implements PiPipelineInterpreter {
    ...
    public Collection<PiPacketOperation> mapOutboundPacket(OutboundPacket packet) throws PiInterpreterException {
        ...
        if (!port.isLogical()) {
            ...
            // Since kitsune.p4 does not support flooding, we create a packet
    ...
    public void kitsunePost(String kitsune) {
        ...
        try {
            ...
            byte[] postData = kitsune.getBytes(StandardCharsets.UTF_8);
            ...
            conn.setRequestProperty("Content-Length", Integer.toString(kitsune.length()));
