...
public final class PipeconfFactory {
    ...
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("p4-kitsune-pipeconf");
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/kitsune-p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/kitsune.json");
