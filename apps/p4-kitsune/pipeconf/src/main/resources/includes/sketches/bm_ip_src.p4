control c_bm_ip_src(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    c_sketch_read() bm_ip_src_read_0;
    c_sketch_read() bm_ip_src_read_1;
    c_sketch_read() bm_ip_src_read_2;
    ...
    apply {
        ...
        bm_ip_src_read_0.apply(hdr, meta, standard_metadata);
        ...
        if (meta.reg.sketch_temp == 0) {
            ...
            bm_ip_src_read_1.apply(hdr, meta, standard_metadata);

            meta.reg.sketch_temp = meta.reg.sketch_temp + 1;
            meta.bm_ip_src.sketch_1 = meta.reg.sketch_temp;
            ...
            bm_ip_src_read_2.apply(hdr, meta, standard_metadata);
