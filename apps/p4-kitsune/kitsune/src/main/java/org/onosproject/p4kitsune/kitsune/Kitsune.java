...
package org.onosproject.p4kitsune.kitsune;
...
public class Kitsune {
    ...
    private static final String APP_NAME = "org.onosproject.p4kitsune.kitsune";
    ...
    private static final Logger log = getLogger(Kitsune.class);
