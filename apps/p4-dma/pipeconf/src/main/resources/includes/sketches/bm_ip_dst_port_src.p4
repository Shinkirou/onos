control c_bm_ip_dst_port_src(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    c_epoch()   bm_ip_dst_port_src_epoch_0;
    c_epoch()   bm_ip_dst_port_src_epoch_1;
    c_epoch()   bm_ip_dst_port_src_epoch_2;
    ...
    apply {
        ...
        bm_ip_dst_port_src_epoch_0.apply(hdr, meta, standard_metadata);
        ...
        if (meta.epoch.sketch_temp[0:0] == 0) {
            ...
            meta.bm_ip_dst_port_src.sketch_1 = meta.epoch.sketch_temp;
