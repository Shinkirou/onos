control c_bm_ip_src_port_dst(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    c_epoch()   bm_ip_src_port_dst_epoch_0;
    c_epoch()   bm_ip_src_port_dst_epoch_1;
    c_epoch()   bm_ip_src_port_dst_epoch_2;
    ...
    apply {
        ...
        meta.reg.current_sketch_hash = meta.bm_ip_src_port_dst.hash_0;
        ...
        bm_ip_src_port_dst_epoch_0.apply(hdr, meta, standard_metadata);
        ...
        if (meta.epoch.sketch_temp[0:0] == 0) {
            ...
            t_bm_ip_src_port_dst_0.apply();

            meta.reg.current_sketch_hash = meta.bm_ip_src_port_dst.hash_1;

            bm_ip_src_port_dst_set_reg_1.apply(hdr, meta, standard_metadata);
            bm_ip_src_port_dst_epoch_1.apply(hdr, meta, standard_metadata);

            meta.epoch.sketch_temp = meta.epoch.sketch_temp + 1;
            meta.bm_ip_src_port_dst.sketch_1 = meta.epoch.sketch_temp;

            current_register();

            t_bm_ip_src_port_dst_1.apply();
            ...
            bm_ip_src_port_dst_epoch_2.apply(hdr, meta, standard_metadata);
