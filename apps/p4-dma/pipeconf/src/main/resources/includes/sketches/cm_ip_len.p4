control c_cm_ip_len(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    c_epoch()   cm_ip_len_epoch_0;
    c_epoch()   cm_ip_len_epoch_1;
    c_epoch()   cm_ip_len_epoch_2;
    ...
    apply {
        ...
        cm_ip_len_epoch_0.apply(hdr, meta, standard_metadata);
        ...
        meta.cm_ip_len.sketch_0 = meta.epoch.sketch_temp;
        ...
        cm_ip_len_epoch_1.apply(hdr, meta, standard_metadata);

        cm_incr();
        current_reg();
        cm_ip_len_write_1.apply(hdr, meta, standard_metadata);
        meta.cm_ip_len.sketch_1 = meta.epoch.sketch_temp;
        ...
        cm_ip_len_epoch_2.apply(hdr, meta, standard_metadata);

        cm_incr();
        current_reg();
        cm_ip_len_write_2.apply(hdr, meta, standard_metadata);
        meta.cm_ip_len.sketch_2 = meta.epoch.sketch_temp;
        ...
        meta.epoch.sketch_temp = meta.cm_ip_len.sketch_final;
        current_reg();
