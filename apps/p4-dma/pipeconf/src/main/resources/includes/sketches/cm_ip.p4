control c_cm_ip(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    c_sketch_write() cm_ip_write_0;
    c_sketch_write() cm_ip_write_1;
    c_sketch_write() cm_ip_write_2;
    c_sketch_write() cm_ip_write_final;
    ...
    apply {
        ...
        cm_incr();
        current_register();
        cm_ip_write_0.apply(hdr, meta, standard_metadata);
        ...
        cm_incr();
        current_register();
        cm_ip_write_1.apply(hdr, meta, standard_metadata);
        ...
        cm_incr();
        current_register();
        cm_ip_write_2.apply(hdr, meta, standard_metadata);
        ...
        current_register();
        cm_ip_write_final.apply(hdr, meta, standard_metadata);
    }
}