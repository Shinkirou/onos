...
public final class PipeconfFactory {
    ...
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("p4-dma-pipeconf");
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/dma-p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/dma.json");
