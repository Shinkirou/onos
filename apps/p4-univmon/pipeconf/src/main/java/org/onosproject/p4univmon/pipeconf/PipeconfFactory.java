...
package org.onosproject.p4univmon.pipeconf;
...
public final class PipeconfFactory {
    ...
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("p4-univmon-pipeconf");
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/univmon.p4info");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/univmon.json");
